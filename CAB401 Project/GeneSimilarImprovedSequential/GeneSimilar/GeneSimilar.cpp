/*
Instructions for running Sequential version of Program:
1. Make sure you have installed Visual Studio 2022 or 2023 with C/C++ capabilities.
2. Open solution file of this program.
3. Select the Solution Configuration: Debug or Release Mode.
4. Clean and Build the Program.
5. Run the program with x64 Solution Platform.
6. Observe the time it takes to finish running the program and the final total correlation score.
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
void CompareAllBacteria()
{
	...
	double totalCorrelation = 0.0; // Store total correlation
	...
	for (int i = 0; i < number_bacteria - 1; i++)
		for (int j = i + 1; j < number_bacteria; j++)
		{
			...
			totalCorrelation += correlation; // Add the correlation values
			printf("%.20lf\n", correlation);
		}
	printf("Total Correlation: %.20lf\n", totalCorrelation);
}
